  ...
  return (
    <div className="absolute top-[1%] left-1/2 transform -translate-x-1/2 text-center z-10">
      ...
      <motion.a
        ...
        className="absolute mt-[-90px] top-[550%] max-2xl:top-[550%] max-xl:top-[552%] max-lg:top-[600%] max-md:top-[600%] max-sm:top-[600%] max-[421px]:!top-[540%] max-[371px]:!top-[540%] text-[14px] font-fugaz font-bold whitespace-nowrap left-1/2 transform -translate-x-1/2 text-white bg-black/50 hover:bg-black/70 py-3 px-6 rounded-lg"
      >
